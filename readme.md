 ...
 * **wrapAttributes** *optional* (`String`): An object containing any attributes to be assigned to the wrapping element (e.g. `{ href:'http://example.com' }`.  If the `wrap` option is not specified, then this option is ignored.
